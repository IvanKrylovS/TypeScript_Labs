...
var date1 = new Date(2005, 2, 23);
var owner1 = new OwnerClass("Малышев", "Артём", "Павлович", date1, TypeOfDocument.passport, "1234", "567890");
var vehicle1 = new VehicleClass("BMW", "X7", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner1);
...
var date2 = new Date(2005, 2, 23);
var owner2 = new OwnerClass("Малышев", "Артём", "Павлович", date2, TypeOfDocument.passport, "1234", "567890");
var car = new CarCl("Cadillac", "XT5", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner2, BodyType.crossover, CarClass.Buisiness);
owner2.printOwnerInfo();
car.printVehicleInfo();
var date = new Date(2005, 2, 23);
var owner = new OwnerClass("Малышев", "Артём", "Павлович", date2, TypeOfDocument.passport, "1234", "567890");
var motorbike = new MotorbikeCl("Progasi Race", "300", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner2, "Дуплексная", true);
owner2.printOwnerInfo();
...
var storage = new VehicleStorageCl();
